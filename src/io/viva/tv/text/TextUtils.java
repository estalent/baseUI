...
public class TextUtils {
	...
	public CharSequence ellipsis(Paint paint, CharSequence text, int width, int padding) {
		...
		if (DEBUG.booleanValue())
			Log.d("TextUtils", "===== desiredLength = " + desiredLength + ", start = " + start);
		if (DEBUG.booleanValue())
			Log.d("TextUtils", "===== mNarrowWidth = " + this.mNarrowWidth + ", mHanziWidth = " + this.mHanziWidth);
		...
		while (startWidth < desiredLength) {
			...
			if (DEBUG.booleanValue())
				Log.d("TextUtils", "==== startWidth = " + startWidth);
