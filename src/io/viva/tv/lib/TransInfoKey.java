...
public class TransInfoKey {
	...
	public TransInfoKey clone(TransInfoKey paramTransInfoKey) {
		TransInfoKey localTransInfoKey = new TransInfoKey(paramTransInfoKey.mTransInfo.x, paramTransInfoKey.mTransInfo.y, paramTransInfoKey.mTransInfo.scaleX, paramTransInfoKey.mTransInfo.scaleY, paramTransInfoKey.mTransInfo.alpha, paramTransInfoKey.mKey);
