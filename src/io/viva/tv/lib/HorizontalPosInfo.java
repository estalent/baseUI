...
public class HorizontalPosInfo {
	...
	private static final HSimpleTransInfo[] mUnstableInfoA2 = { new HSimpleTransInfo(-586.79999F, 0.0F, 0.9F, 1.0F), new HSimpleTransInfo(-240.30005F, 0.0F, 0.85F, 1.0F), new HSimpleTransInfo(86.399963F, 0.0F, 0.8F, 1.0F), new HSimpleTransInfo(393.30005F, 0.0F, 0.75F, 1.0F),
			new HSimpleTransInfo(484.80005F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(576.30005F, 0.0F, 0.65F, 1.0F) };
	private static final HSimpleTransInfo[] mUnstableInfoA3 = { new HSimpleTransInfo(-477.0F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(-50.400024F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(216.8999F, 0.0F, 0.65F, 1.0F), new HSimpleTransInfo(464.3999F, 0.0F, 0.6F, 1.0F),
			new HSimpleTransInfo(535.05005F, 0.0F, 0.55F, 1.0F), new HSimpleTransInfo(606.0F, 0.0F, 0.5F, 1.0F) };
	private static final HSimpleTransInfo[] mUnstableInfoA4 = { new HSimpleTransInfo(-626.40002F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(-199.80005F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(226.80005F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(494.1001F, 0.0F, 0.65F, 1.0F),
			new HSimpleTransInfo(545.1001F, 0.0F, 0.6F, 1.0F), new HSimpleTransInfo(596.1001F, 0.0F, 0.55F, 1.0F) };
	private static final HSimpleTransInfo[] mUnstableInfoA5 = { new HSimpleTransInfo(-636.29999F, 0.0F, 0.65F, 1.0F), new HSimpleTransInfo(-369.0F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(57.600037F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(484.19995F, 0.0F, 0.7F, 1.0F),
			new HSimpleTransInfo(535.19995F, 0.0F, 0.65F, 1.0F), new HSimpleTransInfo(586.19995F, 0.0F, 0.6F, 1.0F) };
	...
	private static final HSimpleTransInfo[] mStableInfoA6 = { new HSimpleTransInfo(-655.95001F, 0.0F, 0.55F, 1.0F), new HSimpleTransInfo(-646.20001F, 0.0F, 0.6F, 1.0F), new HSimpleTransInfo(-595.20001F, 0.0F, 0.65F, 1.0F), new HSimpleTransInfo(-327.90002F, 0.0F, 0.7F, 1.0F),
			new HSimpleTransInfo(98.699951F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(525.30005F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(576.30005F, 0.0F, 0.6F, 1.0F), new HSimpleTransInfo(586.19995F, 0.0F, 0.55F, 1.0F) };
	private static final HSimpleTransInfo[] mUnstableInfoA6 = { new HSimpleTransInfo(-646.20001F, 0.0F, 0.6F, 1.0F), new HSimpleTransInfo(-595.20001F, 0.0F, 0.65F, 1.0F), new HSimpleTransInfo(-327.90002F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(98.699951F, 0.0F, 1.0F, 1.0F),
			new HSimpleTransInfo(525.30005F, 0.0F, 0.7F, 1.0F), new HSimpleTransInfo(576.30005F, 0.0F, 0.6F, 1.0F) };
	private static final HSimpleTransInfo[] mUnstableInfoA7 = { new HSimpleTransInfo(-656.09998F, 0.0F, 0.55F, 1.0F), new HSimpleTransInfo(-605.09998F, 0.0F, 0.6F, 1.0F), new HSimpleTransInfo(-554.09998F, 0.0F, 0.65F, 1.0F), new HSimpleTransInfo(-286.80005F, 0.0F, 0.7F, 1.0F),
			new HSimpleTransInfo(139.80005F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(566.3999F, 0.0F, 0.7F, 1.0F) };
	private static final HSimpleTransInfo[] mUnstableInfoA8 = { new HSimpleTransInfo(-666.0F, 0.0F, 0.5F, 1.0F), new HSimpleTransInfo(-595.20001F, 0.0F, 0.55F, 1.0F), new HSimpleTransInfo(-524.40002F, 0.0F, 0.6F, 1.0F), new HSimpleTransInfo(-276.90002F, 0.0F, 0.65F, 1.0F),
			new HSimpleTransInfo(-9.600037F, 0.0F, 0.75F, 1.0F), new HSimpleTransInfo(417.0F, 0.0F, 1.0F, 1.0F) };
	...
	private static final HSimpleTransInfo[] mSelectPos = { new HSimpleTransInfo(-586.79999F, 0.0F, 0.9F, 0.0F), new HSimpleTransInfo(-477.0F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(-199.80005F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(57.600037F, 0.0F, 1.0F, 1.0F),
			new HSimpleTransInfo(98.699951F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(139.80005F, 0.0F, 1.0F, 1.0F), new HSimpleTransInfo(417.0F, 0.0F, 1.0F, 1.0F) };
	...
	public static TransInfo getSelectPos(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2) {
		...
		return new TransInfo(localHSimpleTransInfo.X * f - paramFloat1 + paramFloat3, localHSimpleTransInfo.Y * f - paramFloat2 + paramFloat4, localHSimpleTransInfo.Scale, localHSimpleTransInfo.Scale, localHSimpleTransInfo.Alpha);
	}
	...
	private static PosInfo SelectorAlphaChange(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8, float paramFloat9, float paramFloat10, float paramFloat11, float paramFloat12,
			float paramFloat13) {
		TransInfoKey localTransInfoKey1 = new TransInfoKey(paramFloat6 * paramFloat5 - paramFloat1 + paramFloat3, paramFloat8 * paramFloat5 - paramFloat2 + paramFloat4, paramFloat10, paramFloat10, paramFloat12, 0.0F);
		TransInfoKey localTransInfoKey2 = new TransInfoKey(paramFloat7 * paramFloat5 - paramFloat1 + paramFloat3, paramFloat9 * paramFloat5 - paramFloat2 + paramFloat4, paramFloat11, paramFloat11, paramFloat13, 1.0F);
		TransInfoKey localTransInfoKey3 = new TransInfoKey((paramFloat6 + (paramFloat7 - paramFloat6) * 0.4F) * paramFloat5 - paramFloat1 + paramFloat3, paramFloat8 * paramFloat5 - paramFloat2 + paramFloat4, paramFloat10 + 0.4F * (paramFloat11 - paramFloat10), paramFloat10
				+ 0.4F * (paramFloat11 - paramFloat10), 0.3F, 0.4F);
		TransInfoKey localTransInfoKey4 = new TransInfoKey((paramFloat6 + 0.6F * (paramFloat7 - paramFloat6)) * paramFloat5 - paramFloat1 + paramFloat3, paramFloat9 * paramFloat5 - paramFloat2 + paramFloat4, paramFloat10 + 0.6F * (paramFloat11 - paramFloat10), paramFloat10
				+ 0.6F * (paramFloat11 - paramFloat10), 0.3F, 0.6F);
	...
	public static PosInfo getAnimStablePos(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2, int paramInt3) {
		...
		localHSimpleTransInfo = null;
		localPosInfo = new PosInfo(f1 * f9 - paramFloat1 + paramFloat3, f5 * f9 - paramFloat1 + paramFloat3, f2 * f9 - paramFloat2 + paramFloat4, f6 * f9 - paramFloat2 + paramFloat4, f3, f7, f3, f7, f4, f8);
		return localPosInfo;
	}
	...
	public static PosInfo getAnimUnstablePos(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
		...
		if (paramInt1 == 1)
			...
			localPosInfo = new PosInfo(f5 * f9 - paramFloat1 + paramFloat3, f1 * f9 - paramFloat1 + paramFloat3, f6 * f9 - paramFloat2 + paramFloat4, f2 * f9 - paramFloat2 + paramFloat4, f7, f3, f7, f3, f8, f4);
		return localPosInfo;
	}
	...
	public static PosInfo getUniversalAnimatorPosInfo(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) {
		if (paramInt3 < 6)
			return null;
		int i = 0;
		int j = 1;
	...
	private static TransInfoKey pointToStatus(float paramFloat, int paramInt1, int paramInt2, BasePositionInfo paramBasePositionInfo) {
		...
		if (paramInt1 != ANI_STATUS_A6) {
			...
			TransInfoKey localTransInfoKey = new TransInfoKey(localHSimpleTransInfo.X * f - paramBasePositionInfo.originX + paramBasePositionInfo.destX, localHSimpleTransInfo.Y * f - paramBasePositionInfo.originY + paramBasePositionInfo.destY, localHSimpleTransInfo.Scale,
					localHSimpleTransInfo.Scale, localHSimpleTransInfo.Alpha, paramFloat);
	...
	private static TransInfoKey pointToSelectorStatus(float paramFloat, int paramInt, BasePositionInfo paramBasePositionInfo) {
		...
		return new TransInfoKey(localHSimpleTransInfo.X * f - paramBasePositionInfo.originX + paramBasePositionInfo.destX, localHSimpleTransInfo.Y * f - paramBasePositionInfo.originY + paramBasePositionInfo.destY, localHSimpleTransInfo.Scale, localHSimpleTransInfo.Scale,
				localHSimpleTransInfo.Alpha, paramFloat);
	}

	public static PosInfo getUniversalSelectorPosInfo(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
		if (paramInt2 < 6)
			return null;
		int i = 0;
		int j = 1;
	...
	private static void SelectorAlphaChange(PosInfo paramPosInfo, TransInfoKey paramTransInfoKey1, TransInfoKey paramTransInfoKey2, BasePositionInfo paramBasePositionInfo) {
		...
		float f = paramBasePositionInfo.radio;
		TransInfoKey localTransInfoKey1 = new TransInfoKey(localTransInfo1.x + (localTransInfo2.x - localTransInfo1.x) * 0.4F, localTransInfo1.y, localTransInfo1.scaleX + 0.4F * (localTransInfo2.scaleX - localTransInfo1.scaleX), localTransInfo1.scaleY + 0.4F
				* (localTransInfo2.scaleY - localTransInfo1.scaleY), 0.3F, 0.4F);
		TransInfoKey localTransInfoKey2 = new TransInfoKey(localTransInfo1.x + 0.6F * (localTransInfo2.x - localTransInfo1.x), localTransInfo2.y, localTransInfo1.scaleX + 0.6F * (localTransInfo2.scaleX - localTransInfo1.scaleX), localTransInfo1.scaleY + 0.6F
				* (localTransInfo2.scaleY - localTransInfo1.scaleY), 0.3F, 0.6F);
	...
	public static TransInfo getUniversalInitialPosInfo(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
		if (paramInt2 < 6)
			return null;
		BasePositionInfo localBasePositionInfo = new BasePositionInfo(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramInt1);
		float f = 0.0F;
	...
	public static TransInfo getUniversalInitialSelectorPosInfo(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, int paramInt2, int paramInt3) {
		if (paramInt2 < 6)
			return null;
		BasePositionInfo localBasePositionInfo = new BasePositionInfo(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramInt1);
		float f = 0.0F;
