...
public class PosInfo {
	...
	public PosInfo(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8, float paramFloat9, float paramFloat10) {
		this(new TransInfoKey[] { new TransInfoKey(paramFloat1, paramFloat3, paramFloat5, paramFloat7, paramFloat9, 0.0F), new TransInfoKey(paramFloat2, paramFloat4, paramFloat6, paramFloat8, paramFloat10, 1.0F) });
	}
...
/*
 * Location: F:\ali\client\AliYingshi\lib\AliTvAppSdk.jar Qualified Name:
