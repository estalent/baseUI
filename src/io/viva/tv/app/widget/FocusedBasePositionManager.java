...
public abstract class FocusedBasePositionManager {
	...
	public void drawFrame(Canvas paramCanvas) {
		LOG.d("FocusedBasePositionManager", this.DEBUG, "drawFrame: mCurrentFrame = " + this.mCurrentFrame + ", needDraw = " + this.mNeedDraw + ", mode = " + this.mode + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", mFocusFrameRate = "
	...
	public void setSelectedView(View paramView) {
		LOG.i("FocusedBasePositionManager", this.DEBUG, "setSelectedView v = " + paramView);
	...
	private void scaleSelectedView() {
		...
		if (localView != null) {
			...
			LOG.d("FocusedBasePositionManager", this.DEBUG, "scaleSelectedView: dstScaleX = " + f3 + ", dstScaleY = " + f4 + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", Selected View = " + localView + ", this = " + this);
	...
	private void scaleLastSelectedView() {
		if (this.mLastSelectedView != null) {
			...
			float f3 = 1.0F + f1 * j / i;
			float f4 = 1.0F + f2 * j / i;
			LOG.d("FocusedBasePositionManager", this.DEBUG, "scaleLastSelectedView: dstScaleX = " + f3 + ", dstScaleY = " + f4 + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", mLastSelectedView = " + this.mLastSelectedView + ", this = "
	...
	private void drawScale(boolean paramBoolean) {
		LOG.i("FocusedBasePositionManager", this.DEBUG, "drawScale: mCurrentFrame = " + this.mCurrentFrame + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", this = " + this + ", mScaleCurrentView = " + this.mScaleCurrentView
				+ ", mScaleLastView = " + this.mScaleLastView);
	...
	private void drawStaticFocus(Canvas paramCanvas) {
		...
		float f3 = 1.0F + f1 * j / i;
		float f4 = 1.0F + f2 * j / i;
		LOG.i("FocusedBasePositionManager", this.DEBUG, "drawStaticFocus: mCurrentFrame = " + this.mCurrentFrame + ", dstScaleX = " + f3 + ", dstScaleY = " + f4 + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", this = " + this);
	...
	private void drawDynamicFocus(Canvas paramCanvas) {
		...
		LOG.i("FocusedBasePositionManager", this.DEBUG, "drawDynamicFocus: mCurrentFrame = " + this.mCurrentFrame + ", dstRect.left = " + localRect.left + ", dstRect.right = " + localRect.right + ", dstRect.top = " + localRect.top + ", dstRect.bottom = " + localRect.bottom
				+ ", this = " + this);
		this.mCurrentRect = localRect;
		this.mMySelectedDrawable.setBounds(localRect);
		this.mMySelectedDrawable.draw(paramCanvas);
	...
	public void computeScaleXY() {
		if ((2 == this.mScaledMode) || (3 == this.mScaledMode)) {
			...
			LOG.d("FocusedBasePositionManager", this.DEBUG, "computeScaleXY mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", mFixedScaledX = " + this.mFixedScaledX + ", mFixedScaledY = " + this.mFixedScaledY + ", height = " + j + ", width = "
					+ i);
		}
	}
