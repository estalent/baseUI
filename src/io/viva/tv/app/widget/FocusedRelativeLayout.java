...
public class FocusedRelativeLayout extends RelativeLayout implements FocusedBasePositionManager.PositionInterface {
	...
	protected void onFocusChanged(boolean paramBoolean, int paramInt, Rect paramRect) {
		Log.d("FocusedRelativeLayout", "onFocusChanged this = " + this + ", mScreenWidth = " + this.mScreenWidth + ", mIndex = " + this.mIndex + ", gainFocus = " + paramBoolean + ", child count = " + getChildCount());
		synchronized (this) {
	...
	public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent) {
		...
		if ((localView != null) && (this.mNodeMap.containsKey(localView))) {
			...
			if (v != null) {
				v.setSelected(false);
				performItemSelect(v, false);
				OnFocusChangeListener localObject2 = v.getOnFocusChangeListener();
				if (localObject2 != null)
					((View.OnFocusChangeListener) localObject2).onFocusChange(v, false);
			}
	...
	void scrollFull() {
		...
		if ((this.mStartX - i > 3) && (!this.mOutsieScroll)) {
			...
			Log.d("FocusedRelativeLayout", "scrollFull to left dx = " + m + ", mStartX = " + this.mStartX + ", currX = " + this.mScroller.getCurrX() + ", mScreenWidth = " + this.mScreenWidth + ", left = " + i);
	...
	class HotScroller extends Scroller {
		...
		public boolean computeScrollOffset() {
			...
			Log.d("FocusedRelativeLayout", "computeScrollOffset isFinished = " + bool1 + ", mOutsieScroll = " + FocusedRelativeLayout.this.mOutsieScroll + ", needInvalidate = " + bool2 + ", this = " + this);
