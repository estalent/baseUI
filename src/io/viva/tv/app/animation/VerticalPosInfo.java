...
public class VerticalPosInfo {
	...
	private static PosInfo DelayEntrance(float originX, float originY, float destX, float destY, float radio, float startX, float endX, float startY, float endY, float startScale, float endScale, float startAlpha, float endAlpha) {
